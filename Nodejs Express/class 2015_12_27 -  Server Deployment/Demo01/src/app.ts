...
//mongoose.connect('mongodb://test:test@ds037095.mongolab.com:37095/todos');
...
complexModel.update({ "_id" : "56769bed8b6013e015975f5a" }, { name : "Test12" }, { multi : false }, function(err, count){
